...
const AilmentGuide: React.FC = () => {
  ...
  const categories = [
    { name: 'Digestive System', count: 2, icon: <Leaf size={16} /> },
    { name: 'Respiratory System', count: 1, icon: <Wind size={16} /> },
    { name: 'Musculoskeletal', count: 1, icon: <Plus size={16} /> },
    { name: 'Skin Conditions', count: 2, icon: <Droplets size={16} /> },
    { name: 'Mental Health', count: 3, icon: <Brain size={16} /> },
    { name: 'Metabolic Disorders', count: 3, icon: <Activity size={16} /> },
  ];
  ...
  const conditions = [
    {
      ...
      description: 'Joint inflammation causing pain, stiffness, and reduced mobility. Ayurveda addresses the root...',
      dosha: 'Vata',
      ...
      tags: ['Joint pain', 'Stiffness', 'Swelling'],
      timeframe: '3-6 months',
      articles: 12,
      categories: ['Digestive System', 'Respiratory System'],
      fullDescription: 'Sandhivata is caused by an accumulation of Vata in the joints, leading to a reduction in lubrication. This causes friction, pain, and eventual degeneration.',
      protocol: ['Snehan (Internal & External Oleation)', 'Swedan (Herbal Fomentation)', 'Vata-balancing diet rich in healthy fats', 'Specific Yoga asanas for mobility']
    },
    {
      id: 2,
      ...
      description: 'Metabolic disorder affecting blood sugar regulation. Ayurvedic treatment focuses on Kaph...',
      dosha: 'Kapha',
      doshaColor: 'bg-blue-100 text-blue-800',
      image: 'https://images.unsplash.com/photo-1612277795421-9bc7706a4a34?auto=format&fit=crop&q=80&w=600',
      tags: ['Increased thirst', 'Frequent urination', 'Fatigue'],
      timeframe: '6-12 months',
      articles: 18,
      categories: ['Musculoskeletal', 'Skin Conditions'],
      fullDescription: 'Prameha primarily involves Kapha Dosha which affects fat tissue and body fluids, leading to metabolic imbalance.',
      protocol: ['Deepan-Pachan to ignite Agni', 'Udwarthanam (Dry powder massage)', 'Bitters like Karela & Jamun', 'Strict Kapha-reducing lifestyle']
    }
  ];
